...
urlpatterns = [
    #url(r'^$', views.home, name='home'),example of function based view url
    url(r'^$', views.BoardListView.as_view(), name='home'),#example of a generic calssbased view which uses listview
    url(r'^signup/$', accounts_views.signup, name='signup'),
    url(r'^login/$', auth_views.LoginView.as_view(template_name='login.html'), name='login'),
    url(r'^logout/$', auth_views.LogoutView.as_view(), name='logout'),
    url(r'^boards/(?P<pk>\d+)/$', views.board_topics, name='board_topics'),
    #url(r'^boards/(?P<pk>\d+)/$', views.TopicListView.as_view(), name='board_topics'),#url for GCBV for pagination of topics
...
url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/edit/$',
    views.PostUpdateView.as_view(), name='edit_post'),#this url directs us to a classbased view called postupdateview
